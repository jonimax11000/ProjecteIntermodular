  ...
  static Map<String, String> get urls {
    if (kIsWeb) {
      return {
        ...
        "catalegByEdat": "https://localhost:8081/api/catalegByEdat/:id",
        "catalegByNivell": "https://localhost:8081/api/catalegByNivell/:id",
    ...
    if (Platform.isAndroid) {
      return {
        ...
        "catalegByCategoria":
            "https://10.0.2.2:8081/api/catalegByCategoria/:id",
        "catalegByEdat": "https://10.0.2.2:8081/api/catalegByEdat/:id",
        "catalegByNivell": "https://10.0.2.2:8081/api/catalegByNivell/:id",
    ...
    return {
      ...
      "catalegBySeries": "https://10.0.2.2:8081/api/catalegBySerie/:id",
      "catalegByName": "https://10.0.2.2:8081/api/catalegByName/:name",
      "catalegByCategoria": "https://10.0.2.2:8081/api/catalegByCategoria/:id",
      "catalegByEdat": "https://10.0.2.2:8081/api/catalegByEdat/:id",
      "catalegByNivell": "https://10.0.2.2:8081/api/catalegByNivell/:id",
      "video": "https://10.0.2.2:3000/api",
      "series": "https://10.0.2.2:8081/api/series",
